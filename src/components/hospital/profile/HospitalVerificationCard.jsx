            ...
            <div className="space-y-2 mt-2">
              {verification.emailMsg ? (
                <div className="flex gap-1.5">
                  <input type="text" placeholder="Enter OTP" value={verification.emailOtp} onChange={e => handleEmailInputChange(e.target.value, verification)} className="w-full px-2 py-1 text-xs border rounded focus:outline-none" />
          ...
          {!verification.phoneVerified && (
            <div className="space-y-2 mt-2">
              {verification.phoneMsg ? (
                <div className="flex gap-1.5">
                  <input type="text" placeholder="Enter OTP" value={verification.phoneOtp} onChange={e => handleMobileInputChange(e.target.value, verification)} className="w-full px-2 py-1 text-xs border rounded focus:outline-none" />
