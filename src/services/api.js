  ...
  try {
    ...
    if (!response.ok) {
      if (
        ...
        // REMOVED: document.cookie deletion attempts (JS cannot delete HttpOnly cookies).
        // Optional: Call your logout API endpoint to clear the cookie server-side if needed.
